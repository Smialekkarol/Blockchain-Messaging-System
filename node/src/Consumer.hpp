...
public:
    ...
    // static void run(const common::NodeConfiguration& config, Buffer &buffer);
...
private:
    ...
    void sendDataToClients(const std::string& clientName, const std::vector<common::itf::Message>& data);
};
